...
description: Хранитель knowledge base. Обновляет институциональную память проекта на основе подтверждённых предложений от v2_judge. Запускается только после явного подтверждения пользователем правил из librarian_suggestions.md.
---
