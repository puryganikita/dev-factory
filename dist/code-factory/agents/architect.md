...
2. **Если в папке задачи есть `design_context/`** — прочитай все файлы в ней. Это первоисточник дизайн-спецификации: точные CSS-значения, цвета, отступы, типографика, иерархия элементов. Используй эти данные при проектировании UI-компонентов.
...
- **При наличии `design_context/`** — используй точные значения из дизайна (цвета, размеры, spacing) при описании UI-компонентов в типах и контрактах
