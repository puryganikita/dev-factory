---
name: mentor
description: Наставник конвейера — изучает результаты analyst/architect/engineer/developer и объясняет как устроено и работает реализованное решение. Используй при вызове /mentor или когда пользователь просит объяснить задачу, разобрать реализацию, оценить результат конвейера.
---
